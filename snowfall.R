...
# Filter out records before 6 AM EST on Feb 23, 2026
cutoff_time <- as.POSIXct("2026-02-23 06:00:00", tz = "America/New_York")

cat("\nFiltering records before 6 AM EST on Feb 23, 2026\n")
...
cat("Records after 6 AM EST Feb 23 filter:", nrow(snowfall_totals), "\n\n")
