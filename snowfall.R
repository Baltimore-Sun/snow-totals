...
# Filter out records before 8 PM EST on Feb 22, 2026
cutoff_time <- as.POSIXct("2026-02-22 20:00:00", tz = "America/New_York")

cat("\nFiltering records before 8 PM EST on Feb 22, 2026\n")
...
cat("Records after 8 PM EST Feb 22 filter:", nrow(snowfall_totals), "\n\n")
